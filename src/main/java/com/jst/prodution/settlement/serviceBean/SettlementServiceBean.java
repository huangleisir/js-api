...
public class SettlementServiceBean extends BaseBean {
    ...
    private String allSucc;//全部成功 - 0， 部分成功- 1
    private List<SettlementPorcessServiceBean> lstTranBalanceSettBook;
     ...
     */
    public List<SettlementPorcessServiceBean> getLstTranBalanceSettBook() {
     ...
     */
    public void setLstTranBalanceSettBook(List<SettlementPorcessServiceBean> lstTranBalanceSettBook) {
    ...
    public String getAllSucc() {
        return allSucc;
    }

    public void setAllSucc(String allSucc) {
        this.allSucc = allSucc;
    }
