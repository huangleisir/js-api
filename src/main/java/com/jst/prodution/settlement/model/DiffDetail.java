...
public class DiffDetail implements Serializable{
	...
	private String acqTranAmt;				//收款方金额
    ...
    /**
     * @return the acqTranAmt
     */
    public String getAcqTranAmt() {
        return acqTranAmt;
    }
    /**
     * @param acqTranAmt the acqTranAmt to set
     */
    public void setAcqTranAmt(String acqTranAmt) {
