 ...
 *@description:
 *@author  widon
 *@date: 2017年3月31日 下午6:53:51
 *@since: JDK 1.8
 *@version:V1.0.0
 */
public class UpayResponseChargeModel implements Serializable {
    
    private static final long serialVersionUID = -5936317830421294569L;
    private String id;
...
//  private String openId;                  //openId
    private String thirdUserId;             //第三方userId
    
    private String extra;                   //用户扩展信息
    private List refunds;                   //退款记录 
    
    private String orderType;    //订单类型：1-支付订单、2-充值订单
