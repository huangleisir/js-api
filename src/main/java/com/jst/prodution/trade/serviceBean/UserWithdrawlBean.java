...
public class UserWithdrawlBean extends BaseBean {
	...
	private String userName;			//提现用户姓名
	private String userCode;			//提现用户账户
	private String bankNo;				//提现用户银行卡号
	private Long amount;				//提现金额
	private String systemCode;			//业务系统代号
	private String remark;				//描述
	private String orderNo;				//订单号
	private String bussOrderId;				//防重标识号
