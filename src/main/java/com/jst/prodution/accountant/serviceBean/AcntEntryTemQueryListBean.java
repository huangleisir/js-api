 ...
 * @date 2016年10月24日
 */
public class AcntEntryTemQueryListBean extends BaseBean {
	...
	//------------------------------ 接口输出参数 begin ------------------------------
	private List<AcntEntryTemDetailBean> list;
	...
	public List<AcntEntryTemDetailBean> getList() {
		return list;
	}


	public void setList(List<AcntEntryTemDetailBean> list) {
		this.list = list;
	}
