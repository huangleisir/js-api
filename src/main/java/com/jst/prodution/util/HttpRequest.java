...
public class HttpRequest {
	...
	public static void main(String[] args) {
        ...
        json1.put("phone", "18550405619");
        json1.put("template_code", "1003");//1003 风控短信提醒  1001 发送短信验证码
        json1.put("template_data", json2);
        try {
			String response = sendPostJson("http://10.101.130.212:11380/jst-sms/message/sendVerify", json1.toJSONString());
	 ...
	 */
	public static String sendPostJson(String url, String json) throws ClientProtocolException, IOException{
		String responseBody = "HTTP请求异常";
