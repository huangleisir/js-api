...
public class IdWorker {
    ...
    private static final Map<Long,IdWorker> workerMap = new HashMap<Long, IdWorker>();
    /**
     * 获取流水号
     * @param workerId 统一取值IdWorkerParam中属性
     * @return
     * @throws Exception
     */
    public static Long getNextId(Long workerId) throws Exception
    {
    	if(workerId == null || workerId < 0 || workerId > 1024){
    		throw new Exception("param idWorker must be [0,1024]");
    	}
    	IdWorker iw = workerMap.get(workerId);
        if(iw == null)
        {
        	iw = new IdWorker(workerId);
        	workerMap.put(workerId, iw);
        }
        return iw.nextId();
    }
	...
	/**
	 * getNextId方法的取值
	 * 属性命名【IDWORKER_系统名称_流水号名称】
	 * @author jfLi
	 *
	 */
	public static final class IdWorkerParam{
		private IdWorkerParam(){
			
		}
		public static final Long IDWORKER_TEST_RECHARGE = 18L;
		public static final Long IDWORKER_ACCT_FROZENDETAIL = 17L;
		//账户前置交易订单
		public static final Long IDWORKER_ACCTFRON_TRANORDER = 16L;
		//账户前置执行序列
		public static final Long IDWORKER_ACCTFRON_SEQ = 15L;
		//通道执行序列
		public static final Long IDWORKER_LANE_SEQ = 19L;
		//通道前置执行序列
		public static final Long IDWORKER_LANEFRONT_SEQ = 20L;
		//交易核心订单
		public static final Long IDWORKER_TRANPAY_ORDER = 21L;
		public static final Long IDWORKER_TRANREFUND_ORDER = 21L;

		//交易核心提现订单
		public static final Long IDWORKER_TRAN_CASH_WITH_ORDER = 17L;

		//交易核心风控日志ID
		public static final Long IDWORKER_TRAN_TSM_LOG = 22L;
				
		//交易核心计费订单
		public static final Long IDWORKER_TRANFEE_ORDER = 22L;
		//生成Token
		public static final Long IDWORKER_TOKEN = 22L;
		//
		public static final Long IDWORKER_LANEFRONT_VERIFY_CODE = 23L;
		public static final Long IDWORKER_TRANSETTLEMENT_ORDER = 24L;
	}
