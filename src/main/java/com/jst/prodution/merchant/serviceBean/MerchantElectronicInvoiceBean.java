...
public class MerchantElectronicInvoiceBean extends BaseBean {

	/**
	 * 
	 */
	private static final long serialVersionUID = -3769840030674747837L;
	...
	private String  logStateFlag;			// 日志状态记录字段
	private String  projectName;			// 项目名称
	private String  taxRate;				// 税率
	private List<MerchantElectronicInvoiceBean> invoiceBeanList;
	...
	public List<MerchantElectronicInvoiceBean> getInvoiceBeanList() {
		return invoiceBeanList;
	}
	public void setInvoiceBeanList(
			List<MerchantElectronicInvoiceBean> invoiceBeanList) {
	...
	public String getLogStateFlag() {
		return logStateFlag;
	}
	public void setLogStateFlag(String logStateFlag) {
		this.logStateFlag = logStateFlag;
	}
