 ...
 *
 */
public class JxdInfoQueryListBean extends BaseBean {
     ...
     * @return the jxdInfo
     */
    public List<QueryJxd> getJxdInfo() {
        return jxdInfo;
    }
    /**
     * @param jxdInfo the jxdInfo to set
     */
    public void setJxdInfo(List<QueryJxd> jxdInfo) {
        this.jxdInfo = jxdInfo;
    }
