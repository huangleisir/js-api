...
/**
 * 
 * @ClassName:  TranCorePayingApplyCallBackBean   
 * @Description:代付通知
 * @author: fxp  
 * @date:   2017年7月28日 下午2:33:39   
 *
 */
public class TranCorePayingCallBackBean extends BaseBean {
	private static final long serialVersionUID = 1L;

	private String busNo;			//订单号	  	代付订单流水号			必输
