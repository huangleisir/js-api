...
public class TranCoreMerchantCashWithDrawCallbackBean extends BaseBean {
	...
	private String payResult;		//提现结果：Y提现成功 N提现失败
...
//	private String result;			//处理结果：0：成功 1：失败             输出
