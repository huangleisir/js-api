...
public class TranCoreOfflineWithdrawQueryListBean extends BaseBean {
	...
	private Long tranAmoutSum;

	private List<TranCoreOfflineWithdrawQueryListBean> tranCoreOfflineWithdrawQueryList;
	...
	public List<TranCoreOfflineWithdrawQueryListBean> getTranCoreOfflineWithdrawQueryList() {
		return tranCoreOfflineWithdrawQueryList;
	}

	public void setTranCoreOfflineWithdrawQueryList(
			List<TranCoreOfflineWithdrawQueryListBean> tranCoreOfflineWithdrawQueryList) {
		this.tranCoreOfflineWithdrawQueryList = tranCoreOfflineWithdrawQueryList;
	}
