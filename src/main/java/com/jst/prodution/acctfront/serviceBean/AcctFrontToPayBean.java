 ...
 *
 */
public class AcctFrontToPayBean extends BaseBean {
	...
	private String busTranType;// 业务类型(01-商户提现,02-个人提现,03-代付,04-退款)
	private String sourceFrom; // 业务来源
	private String userId; // 客户标识
	private String acctId; // 账户标识
	private String acctName; // 账户名称
	private String acctType; // 账户类型
	private String topayAcct;//出款账号(若为空,则渠道编码channelCode必输)
	private String channelNo;// 渠道流水号
	private String channelCode;// 渠道编码(微信支付-WeChat,支付宝支付-Alipay,快钱-KQ,预付卡-YFK,捷易付-JYF,建行-JH,云平台-Cloud)
	...
	public String getTopayAcct() {
		return topayAcct;
	}

	public void setTopayAcct(String topayAcct) {
		this.topayAcct = topayAcct;
	}
